...
import { defineNuxtPlugin, useRuntimeConfig, useRouter, usePlentyEvent } from '#imports';
...
export default defineNuxtPlugin(() => {
  ...
  on('frontend:beginCheckout', () => {
    if (!canTrack()) return;
    window._paq.push(['trackEvent', 'Checkout Funnel', '01 Checkout opened']);
  });
